...
public class add_participant_list_adapter extends ArrayAdapter<User>{
    ...
    public add_participant_list_adapter(Context context, int resource, ArrayList<User> data){
