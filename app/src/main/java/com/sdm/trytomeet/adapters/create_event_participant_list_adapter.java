...
public class create_event_participant_list_adapter extends ArrayAdapter<User>{

    Context context;
    int resource;
    ArrayList<User> data;

    public create_event_participant_list_adapter(Context context, int resource, ArrayList<User> data){
